...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("usage_tips", postgresql.JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        ...
        sa.Column("visual", sa.String(30), nullable=False, server_default=sa.text("'product'")),
        ...
        sa.Column("author", sa.String(100), nullable=False, server_default=sa.text("'Prompt123 编辑部'")),
