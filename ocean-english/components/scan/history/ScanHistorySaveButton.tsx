...
export function ScanHistorySaveButton({
  ...
  return (
    <div style={{ marginTop: '20px', padding: '14px 16px', background: 'rgba(56,189,248,0.04)', border: '1px solid rgba(59,91,217,0.1)', borderRadius: '10px' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px', marginBottom: '8px' }}>
        <button
          ...
          style={{
            ...
            border: `1px solid ${isSaved ? 'rgba(52,211,153,0.35)' : 'rgba(59,91,217,0.35)'}`,
      ...
      {count >= 45 && count < 50 && (
        <div style={{ marginTop: '6px', fontSize: '11px', color: 'var(--gold-ink)' }}>
