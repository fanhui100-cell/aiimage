...
window.LexiverseExam = (function () {
  ...
  function galaxySize(galaxyId) { const cat = window.LexiverseCatalog; const g = cat && cat.GALAXIES.find(x => x.id === galaxyId); if (g && g.wordCount) return g.wordCount; const r = srnd(hash(galaxyId + ':size')); return 160 + Math.floor(r() * 460); }
